...
#RESULT - output_class_0.5.fasta file showing the representative seqeunces and output_class_0.5.clstr showing the cluster results from CD-HIT
#Read the FASTA into a list of dicts
with open("output_class_0.5", "r") as f:
